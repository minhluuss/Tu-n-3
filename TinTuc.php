<?php
$ten_css = '<link rel="stylesheet" href="css/TinTuc.css">';
include 'header.php';
?>
...
<section class="anh-md">
    <div class="khung-chung">
        ...
        <section class="khung-chung">
            ...
            <div class="chuyen-trang mb-3">
                <button class="trang truoc">‹</button>

                <button class="trang active">1</button>
                <button class="trang">2</button>
                <button class="trang">3</button>
                <button class="trang">4</button>
                <button class="trang">5</button>
                ...
                <div class="khung-duoi">
                    <div class="khung">
                        ...
                        <div class="phan-noi-dung">
                            ...
                            <h3 class="tieu-de">
                                Phê duyệt chương trình chăm sóc sức khoẻ tâm thần trẻ em, chăm sóc trẻ mồ côi giai đoạn
                                2023 - 2030
                            </h3>
                            <div class="tuong-tac">
                                <span><i class="fa fa-heart"></i> 100</span>
